...
1. 在 Microsoft Edge 中，导航到 Microsoft Purview 合规门户：**https://compliance.microsoft.com**，并使用 MOD 管理员帐户 ****admin@WWLxZZZZZZ.onmicrosoft.com 登录。 管理员的密码应由实验室托管提供程序提供。
...
1. 在 Microsoft Edge**** 中，导航到 Microsoft Purview 合规门户：**https://compliance.microsoft.com**，并以 JoniS@WWLxZZZZZZ.onmicrosoft.com 的身份登录。 Joni 的密码应由实验室托管提供程序提供。
