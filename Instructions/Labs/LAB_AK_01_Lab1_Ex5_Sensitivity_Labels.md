---
ms.openlocfilehash: 26eafb7087574ad51b1f4707e08851882cb11424
ms.sourcegitcommit: 2e9e5dd78a50682b1afef130c7c566b7d929f854
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/27/2022
ms.locfileid: "137899349"
---
...
5. 输入表示“是”的 Y 并按 Enter 键，以确认“不受信任的存储库安全”对话框。  完成此进程可能需要几秒钟时间。

6. 输入以下 cmdlet，以安装最新版 SharePoint Online PowerShell 模块：

    `Install-Module -Name Microsoft.Online.SharePoint.PowerShell`

7. 输入表示“是”的 Y 并按 Enter 键，以确认“不受信任的存储库安全”对话框。

8. 输入以下 cmdlet，以连接到 MS Online 服务：

    `Connect-MsolService`

9. 在“登录到帐户”窗体中，以 Joni Sherman 的身份 JoniS@WWLxZZZZZZ.onmicrosoft.com（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）登录。   Joni 的密码应由实验室托管提供程序提供。
...
14. 在“登录到帐户”窗体中，以 MOD 管理员身份登录。  admin@WWLxZZZZZZ.onmicrosoft.com（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）。  管理员的密码应由实验室托管提供程序提供。
...
17. 输入表示“是”的 Y 并按 Enter 键，以确认更改。
...
3. 在“Microsoft 365 合规性”门户的左侧导航窗格中，选择“信息保护”。   

4. 在“信息保护”页面的“标签”选项卡下，选择“+ 创建标签” 。

5. 此时会启动“新建敏感度标签”向导。 在“为标签命名并创建标签的工具提示”页上的“名称”、“管理员描述”和“用户描述”中，输入以下信息   ：
...
12. 在“自动标记架构化的数据资产(预览)”页面上，选择“下一步”。  
...
16. 在“信息保护”页面上，突出显示（无需选择）新创建的内部标签，然后选择竖着的“...”。 

17. 从下拉菜单中选择“+ 添加子标签”。

18. 此时会启动“新建敏感度标签”向导。 在“为标签命名并创建标签的工具提示”页上的“名称”、“管理员描述”和“用户描述”中，输入以下信息   ：
...
32. 在“自动标记架构化的数据资产(预览)”页面上，选择“下一步”。  
...
15. 在“将默认标签应用于 Power BI 内容(预览)”页面上，选择“下一步”。 
...
2. 在 Microsoft Edge 中，“Microsoft 365 合规性”选项卡应该仍处于打开状态。 选择地址栏并导航到 https://portal.office.com。
...
13. 在“收件人”字段中，输入姓名Allan，然后从下拉列表中选择 Allan Deyoung 。
...
6. 此时会启动“新建敏感度标签”向导。 在“命名并创建标签工具提示”页面上，输入以下信息：
...
21. 在“自动标记架构化的数据资产(预览)”页面上，选择“下一步”。  
...
36. 在“将默认标签应用于 Power BI 内容(预览)”页面上，选择“下一步”。  
