...
2. 在 Microsoft Edge 中，导航到 https://compliance.microsoft.com ，并以 Joni Sherman 身份登录到“Microsoft 365 合规性”门户  。 以 JoniS@WWLxZZZZZZ.onmicrosoft.com 身份登录（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）。  Joni 的密码应由实验室托管提供程序提供。

3. 在“Microsoft 365 合规门户”的左侧导航窗格中，选择“策略”，然后在“数据”下选择“数据丢失防护”。

4. 在“数据丢失防护”窗口中，选择“策略”选项卡，然后选择“+ 创建策略”，以启动新建数据丢失防护策略的向导  。

5. 在“先使用模板或创建自定义策略”页面，向下滚动并选择模板下的“自定义”和“自定义策略”，不过在默认情况下，这些选项都处于已选中状态（如果未选中，则现在选择它们），然后选择“下一步”   。

6. 在“为 DLP 策略命名”页面中，在“名称”字段中键入“信用卡 DLP 策略”，并在“描述”字段中键入“保护信用卡号不被共享”。 。 选择“**下一步**”。

7. 在“选择应用策略的位置”页面上，仅启用要启用的“Teams 聊天和频道消息”选项，然后选择“下一步”  。 
...
19. 在“创建规则”页面的“用户替代”部分的“允许来自 M365 服务的替代”下，选中“允许来自 M365 服务的替代”复选框   **。允许 Exchange、Sharepoint、OneDrive 和 Teams 中的用户替代政策限制**
注意：如果无法选中“允许来自 M365 服务的替代”复选框，请启用“使用策略提示通知 Office 365 用户”（该提示可在上一步的“用户通知 >> Microsoft 365 服务”下找到）  。 

20. 选中“需要业务理由才可替代”复选框
...
3. 在合规中心的左侧导航窗格中，选择“策略”，然后在“数据”下选择“数据丢失防护”   。
...
3. 在“PowerShell”窗口中，键入“Connect-IPPSSession”，然后以“Joni Sherman”身份登录  。 以 JoniS@WWLxZZZZZZ.onmicrosoft.com 身份登录（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）。  Joni 的密码应由实验室托管提供程序提供。
...
2. 在“Microsoft Edge”中，导航到 https://portal.cloudappsecurity.com 并以“MOD 管理员”身份登录到 Microsoft Defendger for Cloud Apps 门户 。 admin@WWLxZZZZZZ.onmicrosoft.com（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）。  管理员的密码应由实验室托管提供程序提供。
...
2. 在“Microsoft Edge”中，“Microsoft Defender for Cloud Apps 门户”选项卡应该仍处于打开状态。 如果是这样，请选择该选项卡并继续进行下一步。 如果已关闭，请在新标签页中导航到 https://portal.cloudappsecurity.com。
...
7. 在“筛选器”区域，展开下拉菜单“公开(Internet)、外部、公开”并添加“内部”  。

8. 在“检查方法”下拉菜单中，选择“数据分类服务” 。

9. 在“选择检查类型…”下拉菜单中，选择“敏感信息类型…” 。

10. 在“选择敏感信息类型”对话框中，选择“信用卡号”，然后选择右上角的“完成”  。
...
3. 在“Power Platform 管理中心”的左侧导航窗格中，选择“策略”下拉菜单，然后选择“数据策略”  。
