...
1. 在“不当离职案例”页面上，从顶部导航栏中选择“设置”，然后选择“访问和权限”下的“选择”按钮。************

1. 在“访问和权限”浮出控件页上，在“用户”下选择“+ 添加”。************

1. 在“添加成员”**** 浮出控件页中搜索“Diego”__，选中“Diego Siciliani”__ 左侧的复选框，然后选择页面底部的“添加”**** 以授予 Diego 对该电子数据展示案例的访问权限。
...
1. 在右侧的“新建保留”弹出页中，在“名称”字段中的“命名保留”下，输入“Wrongful Termination Hold”  。 在“说明”字段中，输入“此法律保留与 Contoso Ltd. 非法解雇诉讼有关，旨在保留与案件有关的所有相关电子数据”，然后选择“下一步”。****__****

1. 在“选择位置”页上，选择“Exchange 邮箱” 。 在“包含”下，选择“选择用户、组或团队” 。

1. 在“Exchange 邮箱”浮出控件页的右侧，在“搜索”字段中搜索“Lidia”，然后选中“Lidia Holloway”左侧的复选框。********__**** 选择“完成”。

1. 返回到“选择位置”页，选择“下一步”********。

1. 在“查询”页上，确保已选择“查询生成器”，然后在“关键字”框中选择垃圾桶以删除此搜索条件  。

      ![“管理角色”选项的屏幕截图](../Media/remove_keyword_search.png)
...
1. 在“新建搜索”向导的“名称和说明”页上，在“名称”字段中输入“Wrongful Termination Search”  。 在“说明”字段中，输入“此搜索与 Contoso Ltd. 非法解雇诉讼有关，旨在识别和收集与案件有关的所有相关电子数据”。 选择“**下一步**”。
...
1. 在“搜索”**** 部分下，选择在上一个任务中执行的“不当离职搜索”****。

1. 在“不当离职搜索”浮出控件页的右侧，选择页面底部的“操作”下拉列表，然后选择“导出结果”。************

1. 在“导出结果”页上的“输出选项”下，选择“所有项，不包括格式无法识别的项、已加密的项或由于其他原因而未编制索引的项”************。
...
1. 在“Wrongful Termination Search_Export”页的顶部，选择“下载结果”以下载结果********。
...
1. 在“不当离职搜索”浮出控件页的右侧，选择页面底部的“操作”下拉列表，然后选择“导出报告”。************

1. 在“导出报告”页上的“输出选项”下，选择“所有项，不包括格式无法识别的项、已加密的项或由于其他原因而未编制索引的项”************。
