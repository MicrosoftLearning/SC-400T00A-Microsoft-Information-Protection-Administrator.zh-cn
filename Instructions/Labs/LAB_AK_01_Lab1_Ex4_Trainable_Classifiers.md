...
5. 显示“选择帐户”页面时，请选择“使用其他帐户”并以 Joni Sherman 身份登录  。 JoniS@WWLxZZZZZZ.onmicrosoft.com（其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）。  Joni 的密码应由实验室托管提供程序提供。
