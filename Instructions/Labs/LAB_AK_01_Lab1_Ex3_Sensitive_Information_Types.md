---
ms.openlocfilehash: 2023c58f15f047c3596c6e5bafe1f836eb7c1b20
ms.sourcegitcommit: 2e9e5dd78a50682b1afef130c7c566b7d929f854
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/27/2022
ms.locfileid: "137899335"
---
...
2. 在“Microsoft Edge”中，导航到 https://compliance.microsoft.com 并以 JoniS@WWLxZZZZZZ.onmicrosoft.com （其中 ZZZZZZ 是实验室托管提供程序提供的唯一租户 ID）登录到 Microsoft 365 合规门户 。  Joni 的密码应由实验室托管提供程序提供。

3. 从左侧窗格中选择“数据分类”。

4. 如果显示“什么是数据分类?”消息，请选择“关闭”，并从顶部窗格中选择“敏感信息类型”  。  提示：如果合规门户中没有显示“敏感信息类型”，可能是因为在之前实验室中 Joni 的权限已更新为合规性管理员，但在浏览器中尚未更新。  你可能需要注销，并以 JoniS 的身份再次登录。

5. 在“敏感信息类型”选项卡上，选择“+ 创建敏感信息类型”打开新建敏感信息类型向导 。

6. 在“为敏感信息类型命名”页面上的“名称”处，键入“Contoso 员工 ID”。

7. 在“说明”字段中键入“Contoso 员工 ID 模式。”， 然后选择“下一步” 。

8. 在“为此敏感信息类型定义模式”页面上，选择“+ 创建模式” 。

9. 在“主要元素”部分，选择“+ 添加主要元素”的下拉字段，然后选择“正则表达式”  。

10. 在“ID”字段中键入“Contoso ID”，并在“常规表达式”字段输入以下内容： *\s[A-Z]{3}[0-9]{6}\s*，然后选择“完成”。
...
13. 在“新建模式”窗口中，将“字符相似度”值减少到 100 个字符。

14. 选择“创建”按钮。

15. 在“为此敏感信息类型定义模式”页面上，选择“下一步” 。

16. 在“选择建议的可信度级别以显示合规性策略”页面上使用默认值，并选择“下一步” 。
...
16. 依次选择“Joni Sherman”、“添加(1)”按钮以及后退箭头按钮 。

17. 验证“成员”下是否列出“Joni Sherman” 。
...
21. 导航到 Microsoft 365 合规中心，地址为 https://compliance.microsoft.com 。
...
29. 在第一个“架构字段名称”中输入“Name”，并选中“字段可搜索”框。
...
39. 单击顶部菜单上的更多选项 (...) 并选择“+ 创建 EDM 敏感信息类型”以打开“EDM 规则包”向导 。  
...
45. 在“主要元素的敏感信息类型”下，选择“选择敏感信息类型” 。 
...
49. 在“为此 EDM 敏感信息类型定义模式”屏幕中选择“下一步”。

50. 在“选择建议的可信度和字符相似度”中，保留默认值，然后选择“下一步” 。

51. 在“命名并描述 EDM 敏感信息类型”页面上，输入“Contoso 员工 EDM”作为名称。
...
23. 通过运行以下 cmdlet，使用你的帐户授权，将数据库上传到租户：
...
2. 在 Microsoft Edge 中，Office 365 合规中心标签页应该仍处于打开状态。 如果是这样，请选择该选项卡并继续进行下一步。 如果已关闭，请在新标签页中导航到 https://compliance.microsoft.com。

3. 从左侧窗格中选择“数据分类”，并从顶部窗格中选择“敏感信息类型”选项卡 。

4. 选择“+ 创建敏感信息类型”打开新建敏感信息类型向导。

5. 在“为敏感信息类型命名”页面上的“名称”字段中，输入“Contoso 疾病清单”。

6. 在“描述”字段中输入“员工可能患有的疾病清单。”， 然后选择“下一步” 。

7. 在“为此敏感信息类型定义模式”页面上，选择“+ 创建模式” 。

8. 选择“主要元素”下面的下拉字段，然后选择“关键字字典” 。

10. 在“添加关键字字典”页面上，输入名称“疾病字典”。 

11. 在“关键字”区域，分行输入以下关键字：
...
13. 在“支持元素”下，选择“+ 添加支持元素或元素组”下拉列表并选择“关键字列表”以添加关键字字典的其他支持  。
...
8. 在 Microsoft Edge 中，“Microsoft 365 合规中心”选项卡应该仍处于打开状态。 如果是这样，请选择该选项卡并继续进行下一步。 如果已关闭，请在新标签页中导航到 https://compliance.microsoft.com。

9. 在左侧导航窗格中，选择“数据分类”，然后选择“敏感信息类型”选项卡 。

10. 在右上角的搜索框中输入“Contoso”，然后按 Enter 键。
...
23. 在“匹配结果”页面上，查看找到的匹配项。 查看完后，选择“完成”。
